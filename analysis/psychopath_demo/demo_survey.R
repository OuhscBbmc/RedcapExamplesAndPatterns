...
pathDirectoryCode <- "./dal/demo_psychopath_extractor.R"
...
#####################################
## @knitr psychopath_characteristics
...
#####################################
## @knitr psychopathic_score_and_lack_of_realistic_goals
