## Setting up the R/REDCap project on a new development computer
...
1. **[GitHub](https://github.com/)** registration is necessary to push modified files to the repository.    First, register a free user account at https://github.com/plans.  Then tell Will your exact username, and he'll add you as a collaborator to our GitHub repository (https://github.com/OuhscCcanMiechvEvaluation/MReporting). {added Sept 2012}
...
* **[msysGit](http://msysgit.github.com/)** allows RStudio to track changes and commit & sync them to the GitHub server. Connect RStudio to GitHub repository.  I moved this to optional (Oct 14, 2012) because the GitHub client (see above) does almost everything that the RStudio plugin does; and it does it a little better and a little more robust; and its installation hasn't given me problems.  {added Oct 2012}
  ...
  * The Repository URL is https://github.com/OuhscCcanMiechvEvaluation/MReporting, and specify a location to save (a copy of) the project on your local computer.  {added Sept 2012}
...
### Locations
* **GitHub repository** https://github.com/OuhscCcanMiechvEvaluation/MReporting {added Sept 2012}
* **File server directory** Ask Thomas, Will or David
* **SQL Server Database** Ask Thomas, Will or David
* **REDCap database** Ask Thomas, Will or David
* **ODBC UserDsn** Your local computer should call it `MiechvEvaluation` for the existing R code to work.  Ask Thomas, Will or David for how to set it up.
